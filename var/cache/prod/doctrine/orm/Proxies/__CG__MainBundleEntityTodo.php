 ...
 */
class Todo extends \MainBundle\Entity\Todo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'MainBundle\\Entity\\Todo' . "\0" . 'id', '' . "\0" . 'MainBundle\\Entity\\Todo' . "\0" . 'content', '' . "\0" . 'MainBundle\\Entity\\Todo' . "\0" . 'isDone', '' . "\0" . 'MainBundle\\Entity\\Todo' . "\0" . 'createdOn', '' . "\0" . 'MainBundle\\Entity\\Todo' . "\0" . 'dueDate', '' . "\0" . 'MainBundle\\Entity\\Todo' . "\0" . 'category'];
        }
