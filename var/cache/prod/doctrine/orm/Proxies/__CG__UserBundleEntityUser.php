...
class User extends \UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'id', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'slug', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'salt', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'roles', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'plainPassword', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'username', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'email', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'password', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'fname', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'lname', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'profession', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'presentation', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'isActive', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'createdOn', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'acceptedRules'];
        }
    ...
    public function getAcceptedRules()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getAcceptedRules', []);

        return parent::getAcceptedRules();
    }
    ...
    public function setUsername($val)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setUsername', [$val]);
    ...
    public function setAcceptedRules($val)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAcceptedRules', [$val]);

        return parent::setAcceptedRules($val);
    }
